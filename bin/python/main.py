...
class Main:
    ...
    @staticmethod
    def main():
        sys_net_Socket().connect(sys_net_Host("localhost"),5000)
        python_Lib.printString(("" + HxOverrides.stringOrNull(python_Lib.lineEnd)))
...
class sys_net_Socket:
    ...
    _hx_methods = ["__initSocket", "connect", "fileno"]
